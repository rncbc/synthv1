...
#include "ui_synthv1widget_palette.h"
...
synthv1widget_palette::synthv1widget_palette ( QWidget *parent, const QPalette& pal )
	: QDialog(parent), p_ui(new Ui::synthv1widget_palette), m_ui(*p_ui)
{
	m_ui.setupUi(this);
...
void synthv1widget_palette::setPalette ( const QPalette& pal, const QPalette& parentPal )
{
...
const QPalette& synthv1widget_palette::palette (void) const
{
	return m_palette;
}


void synthv1widget_palette::setSettings ( QSettings *settings, bool owner )
{
...
QSettings *synthv1widget_palette::settings (void) const
{
	return m_settings;
}
...
void synthv1widget_palette::saveButtonClicked (void)
{
...
void synthv1widget_palette::deleteButtonClicked (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
void synthv1widget_palette::generateButtonChanged (void)
{
	const QColor& color
...
void synthv1widget_palette::resetButtonClicked (void)
{
...
void synthv1widget_palette::detailsCheckClicked (void)
{
...
void synthv1widget_palette::importButtonClicked (void)
{
	const QString& title
...
void synthv1widget_palette::exportButtonClicked (void)
{
	const QString& title
...
void synthv1widget_palette::paletteChanged ( const QPalette& pal )
{
	m_modelUpdated = true;
	if (!m_paletteUpdated)
		setPalette(pal);
...
void synthv1widget_palette::setPaletteName ( const QString& name )
{
...
QString synthv1widget_palette::paletteName (void) const
{
	return m_ui.nameCombo->currentText();
}


void synthv1widget_palette::updateNamedPaletteList (void)
{
	const bool blocked = m_ui.nameCombo->blockSignals(true);
...
void synthv1widget_palette::updateGenerateButton (void)
{
...
void synthv1widget_palette::updateDialogButtons (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
bool synthv1widget_palette::namedPalette ( const QString& name, QPalette& pal ) const
{
	return namedPalette(m_settings, name, pal);
}


bool synthv1widget_palette::namedPalette (
...
QStringList synthv1widget_palette::namedPaletteList (void) const
{
	return namedPaletteList(m_settings);
}


QStringList synthv1widget_palette::namedPaletteList ( QSettings *settings )
{
	QStringList list;
...
QString synthv1widget_palette::namedPaletteConf ( const QString& name ) const
{
	return namedPaletteConf(m_settings, name);
}


QString synthv1widget_palette::namedPaletteConf (
...
void synthv1widget_palette::addNamedPaletteConf (
...
void synthv1widget_palette::deleteNamedPaletteConf ( const QString& name )
{
	if (m_settings) {
...
bool synthv1widget_palette::loadNamedPaletteConf (
...
bool synthv1widget_palette::saveNamedPaletteConf (
...
bool synthv1widget_palette::loadNamedPalette (
		...
		if (name2 == name) {
			...
			while (iter.hasNext()) {
				...
				const QPalette::ColorRole cr
					= synthv1widget_palette::colorRole(key);
...
bool synthv1widget_palette::saveNamedPalette (
...
QPalette::ColorRole synthv1widget_palette::colorRole ( const QString& name )
{
...
bool synthv1widget_palette::isDirty (void) const
{
	return (m_dirtyTotal > 0);
}


void synthv1widget_palette::accept (void)
{
...
void synthv1widget_palette::reject (void)
{
	if (m_dirtyCount > 0) {
...
void synthv1widget_palette::setDefaultDir ( const QString& dir )
{
	if (m_settings) {
...
QString synthv1widget_palette::defaultDir (void) const
{
	QString dir;
...
void synthv1widget_palette::setShowDetails ( bool on )
{
	if (m_settings) {
		m_settings->beginGroup(PaletteEditorGroup);
...
bool synthv1widget_palette::isShowDetails (void) const
{
	bool on = false;
...
void synthv1widget_palette::showEvent ( QShowEvent *event )
{
...
void synthv1widget_palette::resizeEvent ( QResizeEvent *event )
{
...
synthv1widget_palette::PaletteModel::PaletteModel ( QObject *parent )
...
int synthv1widget_palette::PaletteModel::rowCount ( const QModelIndex& ) const
{
	return m_nrows;
}


int synthv1widget_palette::PaletteModel::columnCount ( const QModelIndex& ) const
{
	return 4;
}


QVariant synthv1widget_palette::PaletteModel::data ( const QModelIndex& index, int role ) const
{
	if (!index.isValid())
		return QVariant();
...
bool synthv1widget_palette::PaletteModel::setData (
...
Qt::ItemFlags synthv1widget_palette::PaletteModel::flags ( const QModelIndex& index ) const
{
	if (!index.isValid())
...
QVariant synthv1widget_palette::PaletteModel::headerData (
...
const QPalette& synthv1widget_palette::PaletteModel::palette(void) const
{
	return m_palette;
}


void synthv1widget_palette::PaletteModel::setPalette (
...
QPalette::ColorGroup synthv1widget_palette::PaletteModel::columnToGroup ( int index ) const
{
	if (index == 1)
...
int synthv1widget_palette::PaletteModel::groupToColumn ( QPalette::ColorGroup group ) const
{
...
QWidget *synthv1widget_palette::ColorDelegate::createEditor ( QWidget *parent,
...
void synthv1widget_palette::ColorDelegate::setEditorData (
...
void synthv1widget_palette::ColorDelegate::setModelData ( QWidget *editor,
...
void synthv1widget_palette::ColorDelegate::updateEditorGeometry ( QWidget *editor,
...
void synthv1widget_palette::ColorDelegate::paint ( QPainter *painter,
	const QStyleOptionViewItem& option, const QModelIndex& index ) const
{
...
QSize synthv1widget_palette::ColorDelegate::sizeHint (
	const QStyleOptionViewItem& option, const QModelIndex &index) const
{
...
synthv1widget_palette::ColorButton::ColorButton ( QWidget *parent )
...
const QBrush& synthv1widget_palette::ColorButton::brush (void) const
{
	return m_brush;
}


void synthv1widget_palette::ColorButton::setBrush ( const QBrush& brush )
{
	m_brush = brush;
	update();
}
...
void synthv1widget_palette::ColorButton::paintEvent ( QPaintEvent *event )
{
...
void synthv1widget_palette::ColorButton::chooseColor (void)
{
	const QColor color
...
//-------------------------------------------------------------------------
// synthv1widget_palette::ColorEditor

synthv1widget_palette::ColorEditor::ColorEditor ( QWidget *parent )
	: QWidget(parent)
{
	QLayout *layout = new QHBoxLayout(this);
	layout->setContentsMargins(0, 0, 0, 0);
	m_button = new synthv1widget_palette::ColorButton(this);
...
void synthv1widget_palette::ColorEditor::setColor ( const QColor& color )
{
...
QColor synthv1widget_palette::ColorEditor::color (void) const
{
	return m_button->brush().color();
}


void synthv1widget_palette::ColorEditor::colorChanged (void)
{
	m_changed = true;
	emit changed(this);
}
...
bool synthv1widget_palette::ColorEditor::changed (void) const
{
	return m_changed;
}
...
//-------------------------------------------------------------------------
// synthv1widget_palette::RoleEditor

synthv1widget_palette::RoleEditor::RoleEditor ( QWidget *parent )
	: QWidget(parent)
{
	m_edited = false;
...
void synthv1widget_palette::RoleEditor::setLabel ( const QString& label )
{
	m_label->setText(label);
}


void synthv1widget_palette::RoleEditor::setEdited ( bool on )
{
	QFont font;
	if (on)
		font.setBold(on);
...
bool synthv1widget_palette::RoleEditor::edited (void) const
{
	return m_edited;
}


void synthv1widget_palette::RoleEditor::resetProperty (void)
{
	setEdited(false);
	emit changed(this);
}
...
// end of synthv1widget_palette.cpp
