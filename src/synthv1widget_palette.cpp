...
bool synthv1widget_palette::namedPalette ( const QString& name, QPalette& pal )
{
...
void synthv1widget_palette::saveNamedPalette (
...
void synthv1widget_palette::deleteNamedPalette ( const QString& name )
{
	if (m_settings) {
		m_settings->beginGroup(ColorThemesGroup);
...
QStringList synthv1widget_palette::namedPaletteList (void)
{
...
{
	if (m_settings) {
		m_settings->beginGroup(synthv1widget_paletteGroup);
